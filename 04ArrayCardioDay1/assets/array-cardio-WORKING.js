...
const fifteen2 = inventors.filter((inventor) => { return inventor.year >= 1499 && inventor.year <= 1599 ? true : false; });
...
const sorted1 = inventors.sort((a, b) => {
  if(a.year > b.year){
    return 1;
  } else {
    return -1;
...
const sorted2 = inventors.sort((a, b) => { return a.year > b.year ? 1 : -1 });
...
const oldest = inventors.sort((a, b) => {
  const newArray = [];
  const yearsLived = a.passed - a.year;
